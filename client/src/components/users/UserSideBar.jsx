...
const UserSideBar = ({ user }) => {
  ...
  return (
    <div className="relative w-[260px] h-full">
      <div
        className={`peer absolute top-0 border ${position} h-full w-full object-cover transition-all delay-100 duration-1000`}
      >
        <button
        ...
        <aside className="relative flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
