  ...
  return (
    <div className='mb-16'>
      ...
      <div className="w-full h-full px-5 flex flex-col flex-wrap justify-center items-center">
        <p className='py-3 text-xl md:text-2xl lg:text-3xl text-white'>Can't decide where to go?</p>
        <h1 className='py-3 text-white text-4xl md:text-5xl lg:text-6xl font-bold'>Explore every destination</h1>
